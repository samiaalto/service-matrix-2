      ...
      <div className="labelPreview">
        <div className="labelBorder">
            ...
            <Col className="bringParties" xs={4}>
              <div className="bringReturn">
                ...
                <Row>
                  ...
                  >
                    <div className="returnName">Sandy Sender</div>
                  </OverlayTrigger>
                </Row>
                <Row>
                  {" "}
                ...
                <Row>
                  ...
                  >
                    <Col className="returnPostOffice">HELSINKI</Col>
                  </OverlayTrigger>
                </Row>
              </div>
            </Col>
          ...
          <Row className="bringReceiver">
            <Col xs={9}>
              <Row>
                ...
                <OverlayTrigger
                  placement="top"
                  overlay={overlay("receiverPhone", "BRING")}
                >
          ...
          <Row className="bringShipmentInformation">
            <Col xs={8}>
              <Row>
                <OverlayTrigger
                  placement="top"
                  overlay={overlay("receiverCustomerNo", "BRING")}
                >
            ...
            <Col xs={4} className="bringRecipient">
              ...
              <Row>
                ...
                >
                  <div className="bringRecipientName">Ricky Receiver</div>
                </OverlayTrigger>
              </Row>
              <Row>
                <OverlayTrigger
                ...
                >
                  <div className="bringRecipientName2"></div>
                </OverlayTrigger>
              </Row>
              <Row>
                <OverlayTrigger
                ...
                >
                  <div className="bringRecipientAddress1">Postintaival 7</div>
                </OverlayTrigger>
              </Row>
              <Row>
                <OverlayTrigger
          ...
          <Row>
            <OverlayTrigger
              placement="top"
              overlay={overlay("trackingBarcodeValue", "BRING")}
            >
